...
<script type="text/x-red" data-template-name="nora-thermostat">
    ...
    <div class="form-row">
        <label style="width:auto" for="node-input-commandOnly"><i class="fa fa-exchange"></i>  Indicates if the device operates using one-way (checked) or two-way communication: </label>
        <input type="checkbox" id="node-input-commandOnly" style="display:inline-block; width:auto; vertical-align:top;">
    </div>
    <div class="form-row">
        <label style="width:auto" for="node-input-queryOnly"><i class="fa fa-question"></i>  Required if the device supports query-only execution: </label>
