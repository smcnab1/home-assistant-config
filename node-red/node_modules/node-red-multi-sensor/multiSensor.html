<script type="text/html" data-template-name="multiSensor">
    ...
    <div class="form-row">
        <label for="node-input-useCount"> &nbsp;</label>
        <label style="width:70%">
            <input type="checkbox" id="node-input-useCount" style="display:inline-block; width:15px; vertical-align:baseline;" autocomplete="off">
            <span><i class="fa fa-random"></i> <span data-i18n="label.useCount"></span></span>
        </label>
    </div>
