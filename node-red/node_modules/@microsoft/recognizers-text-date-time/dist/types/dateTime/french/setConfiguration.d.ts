...
export declare class FrenchSetExtractorConfiguration implements ISetExtractorConfiguration {
...
export declare class FrenchSetParserConfiguration implements ISetParserConfiguration {
    readonly durationExtractor: IDateTimeExtractor;
