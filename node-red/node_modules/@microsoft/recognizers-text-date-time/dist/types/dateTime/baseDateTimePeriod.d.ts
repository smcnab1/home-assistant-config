...
export declare class BaseDateTimePeriodExtractor implements IDateTimeExtractor {
    ...
    private matchSimpleCases;
    protected mergeTwoTimePoints(source: string, refDate: Date): Token[];
    private matchDuration;
    protected matchNight(source: string, refDate: Date): Token[];
    private matchRelativeUnit;
}
