...
export declare class BaseDateTimeExtractor implements IDateTimeExtractor {
    ...
    private timeOfTodayBefore;
    private timeOfTodayAfter;
    private specialTimeOfDate;
...
export declare class BaseDateTimeParser implements IDateTimeParser {
    ...
    private parseSpecialTimeOfDate;
    private parseUnspecificTimeOfDate;
    private resolveEndOfDay;
