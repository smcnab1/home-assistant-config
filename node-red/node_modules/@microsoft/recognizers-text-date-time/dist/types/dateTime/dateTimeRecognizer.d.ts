...
export declare function recognizeDateTime(query: string, culture: string, options?: DateTimeOptions, referenceDate?: Date, fallbackToDefaultCulture?: boolean): ModelResult[];
