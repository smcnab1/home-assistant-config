...
QueryProcessor.Expression = `(kB|K[Bb]|K|M[Bb]|M|G[Bb]|G|B)\\b`;
...
(function (BaseNumbers) {
    ...
    BaseNumbers.NumberMultiplierRegex = `(K|k|M|G|T|B|b)`;
    BaseNumbers.MultiplierLookupRegex = `(k|m|t|g|b)`;
...
(function (EnglishNumeric) {
    ...
    EnglishNumeric.NumbersWithSuffix = `(((?<!\\d+\\s*)-\\s*)|(?<=\\b))\\d+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}(?=\\b)`;
    ...
    EnglishNumeric.NumberOrdinalRegex = `(?:first|second|third|fourth|fifth|sixth|seventh|eighth|ninth|tenth|eleventh|twelfth|thirteenth|fourteenth|fifteenth|sixteenth|seventeenth|eighteenth|nineteenth|twentieth|thirtieth|fortieth|fiftieth|sixtieth|seventieth|eightieth|ninetieth)`;
    ...
    EnglishNumeric.BasicOrdinalRegex = `(${EnglishNumeric.NumberOrdinalRegex}|${EnglishNumeric.RelativeOrdinalRegex})`;
    ...
    EnglishNumeric.FractionNounWithArticleRegex = `(?<=\\b)(((${EnglishNumeric.AllIntRegex}\\s+(and\\s+)?)?(an?|one)(\\s+|\\s*-\\s*)(?!\\bfirst\\b|\\bsecond\\b)((${EnglishNumeric.AllOrdinalRegex})|(${EnglishNumeric.RoundNumberOrdinalRegex})|half|quarter))|(half))(?=\\b)`;
    EnglishNumeric.FractionPrepositionRegex = `(?<!${baseNumbers.BaseNumbers.CommonCurrencySymbol}\\s*)(?<=\\b)(?<numerator>(${EnglishNumeric.AllIntRegex})|((?<![\\.,])\\d+))\\s+(over|in|out\\s+of)\\s+(?<denominator>(${EnglishNumeric.AllIntRegex})|(\\d+)(?![\\.,]))(?=\\b)`;
    ...
    EnglishNumeric.DoubleWithMultiplierRegex = `(((?<!\\d+\\s*)-\\s*)|((?<=\\b)(?<!\\d+[\\.,])))\\d+[\\.,]\\d+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}(?=\\b)`;
    ...
    EnglishNumeric.NumberWithSuffixPercentage = `(?<!%)(${baseNumbers.BaseNumbers.NumberReplaceToken})(\\s*)(%(?!${baseNumbers.BaseNumbers.NumberReplaceToken})|(per\\s*cents?|percentage|cents?)\\b)`;
    ...
    EnglishNumeric.MoreRegex = `(?:(bigger|greater|more|higher|larger)(\\s+than)?|above|over|exceed(ed|ing)?|surpass(ed|ing)?|(?<!<|=)>)`;
    ...
    EnglishNumeric.MoreOrEqualSuffix = `((and|or)\\s+(((more|greater|higher|larger|bigger)((?!\\s+than)|(\\s+than(?!(\\s*\\d+)))))|((over|above)(?!\\s+than))))`;
    ...
    EnglishNumeric.DigitalNumberRegex = `((?<=\\b)(hundred|thousand|[mb]illion|trillion|dozen(s)?)(?=\\b))|((?<=(\\d|\\b))${baseNumbers.BaseNumbers.MultiplierLookupRegex}(?=\\b))`;
...
(function (SpanishNumeric) {
    ...
    SpanishNumeric.RoundNumberIntegerRegex = `(mil millones|millones|mill[oó]n|mil|billones|bill[oó]n|trillones|trill[oó]n|cuatrillones|cuatrill[oó]n|quintillones|quintill[oó]n|sextillones|sextill[oó]n|septillones|septill[oó]n)`;
    ...
    SpanishNumeric.MoreRegex = `(más\\s+alt[oa]\\s+que|(m[áa]s|mayor(es)?|por\\s+encima)(\\s+(que|de|del))?|(?<!<|=)>)`;
    SpanishNumeric.LessRegex = `((menos|menor|menores|por\\s+debajo)(\\s+(que|de|del))?|más\\s+baj[oa]\\s+que|(?<!>|=)<)`;
    SpanishNumeric.EqualRegex = `((igual(es)?|equivalente(s)?|equivale|equivalen|son)(\\s+(a|que|de|al|del))?|(?<!<|>)=)`;
    ...
    SpanishNumeric.MoreOrEqualSuffix = `((\\b(y|o)\\b\\s+(m[áa]s|mayor|mayores)((?!\\s+(alt[oa]|baj[oa]|que|de|del))|(\\s+(que|de|del)(?!(\\s*\\d+)))))|como\\s+m[íi]nimo|por\\s+lo\\s+menos|al\\s+menos)`;
    SpanishNumeric.LessOrEqualPrefix = `((no\\s+${SpanishNumeric.MoreRegex})|(como\\s+máximo|como\\s+maximo|como\\s+mucho))`;
    ...
    SpanishNumeric.LessOrEqualSuffix = `((\\b(y|o)\\b\\s+(menos|menor|menores)((?!\\s+(alt[oa]|baj[oa]|que|de|del))|(\\s+(que|de|del)(?!(\\s*\\d+)))))|como\\s+m[áa]ximo)`;
    SpanishNumeric.NumberSplitMark = `(?![,.](?!\\d+))`;
    SpanishNumeric.MoreRegexNoNumberSucceed = `((m[áa]s|mayor|mayores)((?!\\s+(que|de|del))|\\s+((que|de|del)(?!(\\s*\\d+))))|(por encima)(?!(\\s*\\d+)))`;
    SpanishNumeric.LessRegexNoNumberSucceed = `((menos|menor|menores)((?!\\s+(que|de|del))|\\s+((que|de|del)(?!(\\s*\\d+))))|(por debajo)(?!(\\s*\\d+)))`;
    SpanishNumeric.EqualRegexNoNumberSucceed = `((igual|iguales|equivalente|equivalentes|equivale|equivalen)((?!\\s+(a|que|de|al|del))|(\\s+(a|que|de|al|del)(?!(\\s*\\d+)))))`;
    SpanishNumeric.OneNumberRangeMoreRegex1 = `(${SpanishNumeric.MoreOrEqual}|${SpanishNumeric.MoreRegex})\\s*((el|la|los|las)\\s+)?(?<number1>(${SpanishNumeric.NumberSplitMark}.)+)`;
    ...
    SpanishNumeric.OneNumberRangeLessRegex1 = `(${SpanishNumeric.LessOrEqual}|${SpanishNumeric.LessRegex})\\s*((el|la|los|las)\\s+)?(?<number2>(${SpanishNumeric.NumberSplitMark}.)+)`;
    ...
    SpanishNumeric.OneNumberRangeEqualRegex = `${SpanishNumeric.EqualRegex}\\s*((el|la|los|las)\\s+)?(?<number1>(${SpanishNumeric.NumberSplitMark}.)+)`;
    SpanishNumeric.TwoNumberRangeRegex1 = `entre\\s*((el|la|los|las)\\s+)?(?<number1>(${SpanishNumeric.NumberSplitMark}.)+)\\s*y\\s*((el|la|los|las)\\s+)?(?<number2>(${SpanishNumeric.NumberSplitMark}.)+)`;
    ...
    SpanishNumeric.TwoNumberRangeRegex4 = `((de|desde)\\s+)?((el|la|los|las)\\s+)?(?<number1>(${SpanishNumeric.NumberSplitMark}(?!\\b(entre|de|desde|es)\\b).)+)\\s*${SpanishNumeric.TillRegex}\\s*((el|la|los|las)\\s+)?(?<number2>(${SpanishNumeric.NumberSplitMark}.)+)`;
    ...
    SpanishNumeric.DigitalNumberRegex = `((?<=\\b)(mil|millones|mill[oó]n|billones|bill[oó]n|trillones|trill[oó]n|docenas?)(?=\\b))|((?<=(\\d|\\b))${baseNumbers.BaseNumbers.MultiplierLookupRegex}(?=\\b))`;
    ...
    SpanishNumeric.RelativeReferenceOffsetMap = new Map([["", ""]]);
    SpanishNumeric.RelativeReferenceRelativeToMap = new Map([["", ""]]);
...
(function (PortugueseNumeric) {
    ...
    PortugueseNumeric.DigitalNumberRegex = `((?<=\\b)(mil|cem|milh[oõ]es|milh[aã]o|bilh[oõ]es|bilh[aã]o|trilh[oõ]es|trilh[aã]o|milhares|centena|centenas|dezena|dezenas?)(?=\\b))|((?<=(\\d|\\b))${baseNumbers.BaseNumbers.MultiplierLookupRegex}(?=\\b))`;
    ...
    PortugueseNumeric.RelativeReferenceOffsetMap = new Map([["", ""]]);
    PortugueseNumeric.RelativeReferenceRelativeToMap = new Map([["", ""]]);
...
(function (FrenchNumeric) {
    ...
    FrenchNumeric.DigitalNumberRegex = `((?<=\\b)(cent|mille|million|millions|milliard|milliards|billions|billion|douzaine(s)?)(?=\\b))|((?<=(\\d|\\b))${baseNumbers.BaseNumbers.MultiplierLookupRegex}(?=\\b))`;
    ...
    FrenchNumeric.RelativeReferenceOffsetMap = new Map([["", ""]]);
    FrenchNumeric.RelativeReferenceRelativeToMap = new Map([["", ""]]);
...
(function (ChineseNumeric) {
    ...
    ChineseNumeric.SingleRegex = `(?<!${ChineseNumeric.ZeroToNineIntegerRegex})${ChineseNumeric.ZeroToNineIntegerRegex}(?=${ChineseNumeric.AllowListRegex})`;
    ...
    ChineseNumeric.DoubleWithMultiplierRegex = `(${ChineseNumeric.NegativeNumberTermsRegexNum}\\s*)?${ChineseNumeric.ZeroToNineFullHalfRegex}+[\\.．]${ChineseNumeric.ZeroToNineFullHalfRegex}+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}`;
    ...
    ChineseNumeric.NumbersPercentageWithMultiplierRegex = `(?<!${ChineseNumeric.ZeroToNineIntegerRegex})[百佰]\\s*分\\s*之\\s*${ChineseNumeric.ZeroToNineFullHalfRegex}+[\\.．]${ChineseNumeric.ZeroToNineFullHalfRegex}+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}`;
    ...
    ChineseNumeric.FractionPercentageWithMultiplierRegex = `${ChineseNumeric.ZeroToNineFullHalfRegex}+[\\.．]${ChineseNumeric.ZeroToNineFullHalfRegex}+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}\\s*[个個]\\s*[百佰]\\s*分\\s*[点點]`;
    ...
    ChineseNumeric.SimpleNumbersPercentageWithMultiplierRegex = `(?<!${ChineseNumeric.ZeroToNineIntegerRegex})[百佰]\\s*分\\s*之\\s*${ChineseNumeric.ZeroToNineFullHalfRegex}+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}`;
    ...
    ChineseNumeric.IntegerPercentageWithMultiplierRegex = `${ChineseNumeric.ZeroToNineFullHalfRegex}+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}\\s*[个個]\\s*[百佰]\\s*分\\s*[点點]`;
    ...
    ChineseNumeric.MoreRegex = `((大于|多于|高于|超过|大於|多於|高於|超過)了?|>)`;
    ...
    ChineseNumeric.OneNumberRangeMoreRegex3 = `(?<number1>((?!(([,，](?!\\d+))|。|[或者])).)+)\\s*(或|或者)?\\s*([多几余幾餘]|以上|之上|更[大多高])(?![万亿萬億]{1,2})`;
...
(function (JapaneseNumeric) {
    ...
    JapaneseNumeric.AllowListRegex = `(。|，|、|（|）|”｜国|週間|時間|時|匹|キロ|トン|年|個|足|本|\\s|$)`;
    ...
    JapaneseNumeric.NumbersSpecialsCharsWithSuffix = `${JapaneseNumeric.NegativeNumberTermsRegexNum}?${JapaneseNumeric.ZeroToNineFullHalfRegex}+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}`;
    ...
    JapaneseNumeric.DoubleWithMultiplierRegex = `(${JapaneseNumeric.NegativeNumberTermsRegexNum}\\s*)?${JapaneseNumeric.ZeroToNineFullHalfRegex}+[\\.．]${JapaneseNumeric.ZeroToNineFullHalfRegex}+\\s*${baseNumbers.BaseNumbers.NumberMultiplierRegex}`;
    ...
    JapaneseNumeric.RelativeReferenceOffsetMap = new Map([["", ""]]);
    JapaneseNumeric.RelativeReferenceRelativeToMap = new Map([["", ""]]);
...
(function (BaseUnits) {
    ...
    BaseUnits.AmbiguousUnitNumberMultiplierRegex = `(\\s[Kk])`;
...
(function (BaseCurrency) {
    ...
    BaseCurrency.NonStandardFractionalSubunits = new Map([["JOD", 1000], ["KWD", 1000], ["BHD", 1000], ["OMR", 1000], ["YDD", 1000], ["TND", 1000], ["MRO", 5]]);
...
(function (SpanishNumericWithUnit) {
    ...
    SpanishNumericWithUnit.TemperatureSuffixList = new Map([["Kelvin", "k|K|kelvin"], ["Rankine", "r|rankine"], ["Grado Celsius", "°c|grados c|grado celsius|grados celsius|celsius|grado centígrado|grados centígrados|centígrado|centígrados"], ["Grado Fahrenheit", "°f|grados f|grado fahrenheit|grados fahrenheit|fahrenheit"], ["Grado Réaumur", "°r|°re|grados r|grado réaumur|grados réaumur|réaumur"], ["Grado Delisle", "°d|grados d|grado delisle|grados delisle|delisle"], ["Grado", "°|grados|grado"]]);
...
(function (PortugueseNumericWithUnit) {
    ...
    PortugueseNumericWithUnit.CurrencyPrefixList = new Map([["Dólar", "$"], ["Dólar estadunidense", "us$|u$d|usd$|usd"], ["Dólar do Caribe Oriental", "ec$|xcd"], ["Dólar australiano", "a$|aud"], ["Dólar bahamense", "b$|bsd"], ["Dólar de Barbados", "bds$|bbd"], ["Dólar de Belize", "bz$|bzd"], ["Dólar bermudense", "bd$|bmd"], ["Dólar de Brunei", "brunéi $|bnd"], ["Dólar de Cingapura", "s$|sgd"], ["Dólar canadense", "c$|can$|cad"], ["Dólar das Ilhas Cayman", "ci$|kyd"], ["Dólar neozelandês", "nz$|nzd"], ["Dólar fijiano", "fj$|fjd"], ["Dólar guianense", "gy$|gyd"], ["Dólar de Hong Kong", "hk$|hkd"], ["Dólar jamaicano", "j$|ja$|jmd"], ["Dólar liberiano", "l$|lrd"], ["Dólar namibiano", "n$|nad"], ["Dólar das Ilhas Salomão", "si$|sbd"], ["Novo dólar taiwanês", "nt$|twd"], ["Real brasileiro", "r$|brl"], ["Guarani", "₲|gs.|pyg"], ["Dólar de Trinidade e Tobago", "tt$|ttd"], ["Yuan chinês", "￥|cny|rmb"], ["Yen", "¥|jpy"], ["Euro", "€|eur"], ["Florim", "ƒ"], ["Libra", "£"], ["Colón costarriquenho", "₡"], ["Lira turca", "₺"]]);
    ...
    PortugueseNumericWithUnit.TemperatureSuffixList = new Map([["Kelvin", "k|K|kelvin"], ["Grau Rankine", "r|°r|°ra|grau rankine|graus rankine| rankine"], ["Grau Celsius", "°c|grau c|grau celsius|graus c|graus celsius|celsius|grau centígrado|grau centrigrado|graus centígrados|graus centigrados|centígrado|centígrados|centigrado|centigrados"], ["Grau Fahrenheit", "°f|grau f|graus f|grau fahrenheit|graus fahrenheit|fahrenheit"], ["Grau", "°|graus|grau"]]);
