...
(function (DutchChoice) {
    ...
    DutchChoice.TrueRegex = `\\b(ja|jawel|jazeker|natuurlijk|vanzelfsprekend|zeker|prima|jep|yes|yep|y|ok|oke|akkoord)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)`;
    DutchChoice.FalseRegex = `\\b(nee|neen|nope|nein|nop|no|niet|nooit)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)`;
...
(function (EnglishChoice) {
    ...
    EnglishChoice.TrueRegex = `\\b(true|yes|yep|yup|yeah|y|sure|ok|agree)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C|\\u0001f44c)`;
    EnglishChoice.FalseRegex = `\\b(false|nope|nop|no|not\\s+ok|disagree)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90|\\u0001F44E|\\u0001F590)`;
